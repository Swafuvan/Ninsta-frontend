...
// export default function StoryShowPage({ StoryShowing, ownUserStoryData }: any) {
...
//         }}
//       >
//         <ModalContent className="border border-gray-400 w-2/3 bg-slate-200 rounded-md h-5/6 mt-5 ">
//           {(StoryShowing) => (
//             <div>
//               <ModalHeader className="flex flex-col border border-b-black">
...
//   const [previous, setPrevious] = useState(false);
  ...
  function getStoriesObject() {
    const stories = userStory.map((story, index) => {
      return {
        content: (props:any) => (
          <div key={index} className="story-container bg-black w-screen h-screen flex items-start justify-center">
            ...
            <div
              ...
              style={{ backgroundImage: `url(${story.files.fileURL})` }}
            >
              <div
