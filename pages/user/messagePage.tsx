...
function MessagePage({ userDetails }: any) {
    ...
    return (
        <div className="hidden lg:col-span-2 h-screen lg:block sm:w-1/2 md:w-2/3 overflow-hidden lg:w-3/4">
            <div className="w-full">
                ...
                <div className="flex flex-col flex-grow w-full max-w-auto bg-white shadow-xl rounded-lg overflow-hidden">
                    <div className="flex flex-col flex-grow h-screen px-1 py-4 mb-20 overflow-auto">
